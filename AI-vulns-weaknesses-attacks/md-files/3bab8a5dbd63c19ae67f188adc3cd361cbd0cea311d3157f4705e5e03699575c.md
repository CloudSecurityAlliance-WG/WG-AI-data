...
adversarial perturbations are possible because the loss is small for allperturbations allowed by our
...
Corollary A.2. Letdbe such that d2S and is a maximizer for max dL(q,x+d,y). Then, as long as it is
