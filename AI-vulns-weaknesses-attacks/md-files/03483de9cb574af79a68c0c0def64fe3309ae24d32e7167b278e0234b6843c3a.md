3/7/24, 2:54 PM CWE - CWE-26: Path Traversal: '/dir/../ﬁlename' (4.14)
https://cwe.mitre.org/data/deﬁnitions/26.html 1/2
Common W eakness Enumeration
A community-developed list of SW & HW weaknesses that can become
vulnerabilities
Home Search
CWE-26: Path T raversal: '/dir/../filename'
Weakness ID: 26
...
"/dir/../filename" sequences that can resolve to a location that is outside of that directory .
 Extended Description
This allows attackers to traverse the file system to access files or directories that are outside of the restricted directory .
The '/dir/../filename' manipulation is useful for bypassing some path traversal protection schemes. Sometimes a program only checks
...
3/7/24, 2:54 PM CWE - CWE-26: Path Traversal: '/dir/../ﬁlename' (4.14)
https://cwe.mitre.org/data/deﬁnitions/26.html 2/2Phase: Implementation
Strategy: Input V alidation
