3/7/24, 2:55 PM CWE - CWE-30: Path Traversal: '\dir\..\ﬁlename' (4.14)
https://cwe.mitre.org/data/deﬁnitions/30.html 1/2
Common W eakness Enumeration
A community-developed list of SW & HW weaknesses that can become
vulnerabilities
Home Search
CWE-30: Path T raversal: '\dir\..\filename'
Weakness ID: 30
...
This is similar to CWE-26 , except using "\" instead of "/". The '\dir\..\filename' manipulation is useful for bypassing some path traversal
protection schemes. Sometimes a program only checks for "..\" at the beginning of the input, so a "\..\" can bypass that check.
 Relationships
...
3/7/24, 2:55 PM CWE - CWE-30: Path Traversal: '\dir\..\ﬁlename' (4.14)
https://cwe.mitre.org/data/deﬁnitions/30.html 2/2Do not rely exclusively on a filtering mechanism that removes potentially dangerous characters. This is equivalent to a denylist,
